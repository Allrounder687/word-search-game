...
export const WordList: React.FC<WordListProps> = ({ words, theme, showDescriptions = true, kidsMode = false }) => {
    ...
    return (
        <div
            style={{ 
                ...
                minWidth: isSmallScreen ? '100%' : '256px',
                    ...
                    return (
                        <div
                            ...
                            style={{
                                ...
                                minHeight: isMobile ? '44px' : 'auto', // Ensure touch target is large enough
